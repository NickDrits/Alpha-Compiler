...
static const yytype_int16 yyrline[] =
{
     ...
     254,   254,   275,   275,   292,   296,   297,   303,   319,   337,
     356,   374,   392,   398,   402,   397,   444,   445,   446,   447,
     448,   452,   493,   521,   532,   536,   537,   544,   545,   549,
     550,   564,   573,   574,   578,   588,   597,   598,   599,   618,
     630,   644,   650,   666,   675,   674,   686,   705,   706,   685,
     735,   747,   748,   734,   765,   766,   767,   768,   769,   770,
     773,   774,   808,   844,   846,   849,   858,   862,   870,   878,
     885,   898,   912,   922,   921,   942,   941,   954,   953
};
#endif
...
#line 304 "parse.y"
    {
      ...
      (yyval.enode)->sym = newtemp(table,0); 
			if((yyvsp[0].enode)->type!=boolexpr_e){
				...
				emit(assign, (yyval.enode), newexpr_constbool(1), NULL, currQuad, yylineno);
    		emit(jump, newexpr_constnum(nextquadlabel()+2), NULL, NULL, nextquadlabel(), yylineno);
    		emit(assign, (yyval.enode), newexpr_constbool(0), NULL, currQuad, yylineno);
			}
